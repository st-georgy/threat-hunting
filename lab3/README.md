...
Для начала необходимо развернуть систему мониторинга на базе ElasticSearch
...
Для проверки контейнеров используем команду:
```bash
docker-compose ps
```
...
Для настройки сбора информации с помощью Filebeat и Packetbeat, необходимо создать и настроить их конфигурационные файлы
...
Запускаем Filebeat и Packetbeat на ОС Windows 11 командами:
```bash
